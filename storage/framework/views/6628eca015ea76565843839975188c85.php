            ...
            <div class="col-md-12">
                <div class="card" style="max-height: 90vh; overflow-y: auto;">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        <h4 class="my-1">Mahudhurio ya Jumuiya</h4>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.attendance.create')): ?>
                            <div class="btn-group btn-group-md ml-auto" role="group">
                                <a href="<?php echo e(route('admin.attendance.create')); ?>" class="btn btn-outline-light"><i
                                        class="fa fa-calendar-alt fa-md"></i>&nbsp;&nbsp;Ongeza Mahudhurio</a>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(isset($attendances[$member->id])): ?>
                                                        <?php if($attendances[$member->id]->present): ?>
                                                            ...
                                                            <!-- Tick mark for present -->
                                                        <?php else: ?>
                                                            <i class="fas fa-times text-danger"></i>
                                                            <!-- Cross mark for absent -->
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <i class="fas fa-times text-danger"></i>
                                                        <!-- Cross mark for absent if no record -->
                                                    <?php endif; ?>
                                                </td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.attendance.update')): ?>
                                                    <td>
                                                        <?php if(isset($attendances[$member->id])): ?>
                                                            <form
                                                                action="<?php echo e(route('admin.attendance.update', $attendances[$member->id]->id)); ?>"
                                                                method="POST" class="update-form">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('PUT'); ?>
                                                                <select name="present" class="form-control update-attendance"
                                                                    data-id="<?php echo e($attendances[$member->id]->id); ?>">
                                                                    <option value="1"
                                                                        <?php echo e($attendances[$member->id]->present ? 'selected' : ''); ?>>
                                                                        Alihudhuria</option>
                                                                    <option value="0"
                                                                        <?php echo e(!$attendances[$member->id]->present ? 'selected' : ''); ?>>
                                                                        Hakuhudhuria</option>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sjwmdev/dev/viwawa/resources/views/backend/admin/viwawa/attendance/index.blade.php ENDPATH**/ ?>