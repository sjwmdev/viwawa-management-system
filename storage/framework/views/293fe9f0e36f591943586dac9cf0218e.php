                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.monthly.contributions.index')): ?>
                            ...
                            <li class="nav-item <?php echo e(isMenuOpen(['admin.monthly.contributions'])); ?> mt-2">
                                <a href="#" class="nav-link">
...
<?php /**PATH /var/www/html/resources/views/backend/layout/partials/_leftsidebar.blade.php ENDPATH**/ ?>